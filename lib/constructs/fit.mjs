...
import { titleChromeMetrics, stack, columns, inset, placeBlock, flexAllocate } from "./layout-flex.mjs";
 ...
 */
export function createFitContext(theme, data = {}) {
  const space = spaceFromTheme(theme);
  return {
    theme,
    data,
    space,
    contentBox: () => contentBox(theme, data),
    distributeRow,
    distributeCol,
    splitPane,
    measureTextHeight,
