...
export async function loadConstructTheme(name = "scientific", overrides = {}) {
  ...
  return {
    ...
    logoPath,
    logoHeightPx: Number(branding.logo_height_px ?? 44),
    logoWidthPx: Number(branding.logo_width_px ?? branding.logo_height_px ?? 44),
    logoTopPx: Number(branding.logo_top_px ?? 28),
    logoRightPx: Number(branding.logo_right_px ?? 36),
    space: {
      xs: 8,
      sm: 12,
      md: 16,
