...
/**
 * Render a Chart.js config to PNG sized to the slide slot (1 CSS pixel = 1 bitmap pixel).
...
export async function renderChartPng(ctx, buildConfig) {
  ...
  const defaults = {
    ...
    animation: false,
    devicePixelRatio: 1,
    layout: { padding: { left: 12, right: 16, top: 10, bottom: 12 } },
    plugins: {
      legend: {
        display: true,
        position: "top",
    ...
    scales: {
      x: {
        ...
        title: {
          display: false,
          color: fg,
          font: { size: plotTypo.base_pt, weight: "bold" },
          padding: { top: 10 },
        },
      },
      y: {
